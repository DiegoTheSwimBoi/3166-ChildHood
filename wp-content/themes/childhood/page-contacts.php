            ...
            <div class="container">
                ...
                <div class="row">
                        ...
                        <div class="contacts__info">
                            <div class="contacts__phones">
                                <?php $tel_str=get_field("Phone");
                                        ...
                                        foreach ($tel_arr as $key=>$telephone){
                                            ?>
                            ...
                            <div class="contacts__mail">
                                ...
                                <a href="mailto:<?php the_field('about_email',2);?>"><?php the_field('about_email',2);?></a>
                            </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <?php echo do_shortcode('[contact-form-7 id="190" title="Форма отзывов"]');?>
...
?>
        ...
        <div class="reply">
            <div class="reply__body">
                ...
                <?php echo do_shortcode('[contact-form-7 id="191" title="Форма вопросов"]');?>
            </div>
        </div>
